...
In questo caso il valore di SSE è pari a 14.85. È inoltre possibile constatare come l'algoritmo di kmean abbia messo in evidenza tre tipologie ben distinte di studenti:
\begin{itemize}
...
In Tabella Tabella \ref{c3V} sono riportate le coordinate dei centroidi al termine dell'algoritmo. 
